...
\makeatletter
\newcommand{\fitframe}[1]{%
  % #1 = filename (required)
  \@ifnextchar\bgroup
    {\fitframe@withcaption{#1}}% next token is { → caption present
    {\fitframe@nocaption{#1}}% no caption / label
}

% No caption, no label
\newcommand{\fitframe@nocaption}[1]{%
  \begin{figure}
    \centering
...
% Caption given, maybe label
\newcommand{\fitframe@withcaption}[2]{%
  % #1 = filename, #2 = caption
  \@ifnextchar\bgroup
    {\fitframe@withcaptionlabel{#1}{#2}}% label present
    {\fitframe@captiononly{#1}{#2}}% no label
}

% Caption only, no label
\newcommand{\fitframe@captiononly}[2]{%
  \begin{figure}
    \centering
...
% Caption and label
\newcommand{\fitframe@withcaptionlabel}[3]{%
  \begin{figure}
    \centering
    \includegraphics[width=\linewidth,height=0.75\textheight,keepaspectratio]{#1}%
    \caption{\label{#3}#2}%
